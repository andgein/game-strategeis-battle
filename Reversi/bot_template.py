...
from reversi import Game, Bot, Move, ConsolePlayer
...
class MyBot(Bot):
    ...
    если ваш бот играет за чёрные фишки, и 2, если за белые.
    """
    ...
    def move(self, board):
        ...
        Если в board[1][1] лежит значение 0, то она пустая. Если 1, то там находится чёрная фишка,
        а если 2, то белая.
        ...
        Внимательные заметили, что в этом примере мы использовали размер поля board.size. Он всегда равен 8.
